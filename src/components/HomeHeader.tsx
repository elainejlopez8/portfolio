	...
	useEffect(() => {
		const handleScroll = () => {
			...
			const scrollDistance = Math.max(
				height * HOME_HEADER_SHRINK_DISTANCE_FACTOR,
				1,
			);
		...
		>
			<div className="home-header" style={homeHeaderStyle}>
				<div className="home-header-copy">
					...
					<h3 className="home-header-profession type-heading">
						{t("profession")}
					</h3>
					<p
						className="type-body home-header-short-blurb"
						style={collapseStyle}
					>
						{t("short_blurb")}
					</p>
				...
				<img
					src={landing}
					alt="Hi Bitmoji"
					aria-describedby="Hi Bitmoji"
					className="home-header-media"
				/>
			</div>
		</Container>
	);
